...
Build your own image with a supported Lean version with:
```sh
docker build --build-arg=LEAN_SERVER_LEAN_VERSION=v4.15.0 .
```
...
- deploy the Railway gateway/runtime services using the env contract in `docs/DEPLOYMENT.md`
